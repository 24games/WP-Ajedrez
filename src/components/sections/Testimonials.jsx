...
export default function Testimonials() {
  const testimonials = [
    {
      quote: 'El ajedrez es la gimnasia de la inteligencia.',
      author: 'Blaise Pascal'
    },
    {
      quote: 'El ajedrez enseña que cada decisión tiene consecuencias.',
      author: 'Garry Kasparov'
    },
    {
      quote: 'Estudiar finales es el atajo para evolucionar en el juego.',
