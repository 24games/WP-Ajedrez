...
export default function Beginners() {
  const tips = [
    'Aprende las reglas: movimientos de las piezas, jaque, jaque mate y empate.',
    'Controla el centro con peones y desarrolla las piezas rápidamente.',
    'Enroca temprano para proteger al rey y conectar las torres.',
    'Evita mover la misma pieza muchas veces en la apertura.',
    'Practica tácticas básicas diariamente.'
  ]
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">Consejos para Principiantes</h2>
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl border border-gray-200 dark:border-gray-700">
            <img 
              ...
              alt="Piezas de ajedrez en perspectiva para principiantes"
